...
# messages Table
create_table = "CREATE TABLE IF NOT EXISTS messages (name text, message_content text, vote_count int, group_ text, creator text, date_created text)" # messages table schema
cursor.execute(create_table)
...
cursor.execute("INSERT INTO groups VALUES ('Working', 'permanent')")
